...
lodge1 = Lodging.create(name:'Yurt', description: 'Sit by  the fire, Grill up some burgers, hike the trails out the front door, or just chill on the patio of our brand new yurt. ',image: "https://webreserv.com/catalog/dupontyurtskanteen/images/ridgeline2.6-dx-w600-h400-e.jpg" , sleeps: 5, shower: false)
...
# reviews
Review.create(username: 'admin', description: 'We had a great trip! Will be reccomending to others', rating: 'Two Thumbs Up' , lodging_id: lodge1.id)
